...
export default function CoordinadorView({ user, onLogout, globalState, addToast }) {
  ...
  const renderActiveSection = () => {
    switch (sectionActive) {
      ...
      default:
        return <div className="text-white">Sección en desarrollo...</div>;
    }
  };
        ...
        <div>
          ...
          <div className="p-4 flex items-center gap-2.5 border-b border-gray-800/80">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider">Portal Coordinador</p>
            </div>
          </div>
            ...
            <div>
              <div className="p-4 flex items-center justify-between border-b border-gray-800/80">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h2 className="font-extrabold text-xs text-white tracking-wide drop-shadow-sm">CAEDPH Yamboro</h2>
                    <p className="text-[10px] text-gray-400 font-semibold uppercase">Portal Coordinador</p>
                  </div>
                </div>
                <button 
                  onClick={() => setMobileMenuOpen(false)}
